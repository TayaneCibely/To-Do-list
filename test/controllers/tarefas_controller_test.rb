...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference('Tarefa.count') do
      post tarefas_url, params: { tarefa: { data_de_termino: @tarefa.data_de_termino, descricao: @tarefa.descricao, finalizada: @tarefa.finalizada, nome: @tarefa.nome, prioridade: @tarefa.prioridade } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { data_de_termino: @tarefa.data_de_termino, descricao: @tarefa.descricao, finalizada: @tarefa.finalizada, nome: @tarefa.nome, prioridade: @tarefa.prioridade } }
